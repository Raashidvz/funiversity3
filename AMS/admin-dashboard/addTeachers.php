...
<body>
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <label class="warning">warning: make sure subjects has already uploaded !</label>
            ...
            for($i=0;$i<count($_FILES['fileUpload']['name']);$i++){
                ...
                if(in_array($file_extension,$allowed_ext)){
                    ...
                    for($row=1;$row<$sheetcount;$row++){
                        ...
                        $phoneNo = isset($spreadsheetAry[$row][5]) ? $spreadsheetAry[$row][5] : null;
                        $sub1 = isset($spreadsheetAry[$row][6]) ? $spreadsheetAry[$row][6] : null;
                        $sub2 = isset($spreadsheetAry[$row][7]) ? $spreadsheetAry[$row][7] : null;
                        $sub3 = isset($spreadsheetAry[$row][8]) ? $spreadsheetAry[$row][8] : null;
                        $sub4 = isset($spreadsheetAry[$row][9]) ? $spreadsheetAry[$row][9] : null;
                            ...
                            if($deciscion[1]==$username){
                                ...
                                if($data2){
                                    ...
                                    if($data){
                                        ...
                                        if($data && $data2){
                                            ...
                                            // subject3
                                            if(in_array($SUB3,$allowed_sub)){
                                                $sql1="SELECT * FROM subjects WHERE SUBJECT_NAME='$SUB3'";
                                                $data=mysqli_query($dbcon,$sql1);
                                                if($data){
                                                    $sub_row=mysqli_fetch_array($data);
                                                    if($sub_row['TEACHER_ID']==null){
                                                        $sql5="UPDATE subjects SET TEACHER_ID='$teacherID[0]' WHERE SUBJECT_NAME='$SUB3'";
                                                        $data5=mysqli_query($dbcon,$sql5);
                                                    }else if($sub_row['TEACHER_ID2']==null){
                                                        $sql5="UPDATE subjects SET TEACHER_ID2='$teacherID[0]' WHERE SUBJECT_NAME='$SUB3'";
                                                        $data5=mysqli_query($dbcon,$sql5);
                                                    }
                                                    //Now we have to give acess to teacher to know details about students of this batch
                                                    //So lets add this batch to routemap table
                                            ...
                                            // subject4 
                                            if(in_array($SUB4,$allowed_sub)){
                                                $sql1="SELECT * FROM subjects WHERE SUBJECT_NAME='$SUB4'";
                                                $data=mysqli_query($dbcon,$sql1);
                                                if($data){
                                                    $sub_row=mysqli_fetch_array($data);
                                                    if($sub_row['TEACHER_ID']==null){
                                                        $sql5="UPDATE subjects SET TEACHER_ID='$teacherID[0]' WHERE SUBJECT_NAME='$SUB4'";
                                                        $data5=mysqli_query($dbcon,$sql5);
                                                    }else if($sub_row['TEACHER_ID2']==null){
                                                        $sql5="UPDATE subjects SET TEACHER_ID2='$teacherID[0]' WHERE SUBJECT_NAME='$SUB4'";
                                                        $data5=mysqli_query($dbcon,$sql5);
                                                    }
                                                    //Now we have to give acess to teacher to know details about students of this batch
                                                    //So lets add this batch to routemap table
                                ...
                                if($data){
                                    ...
                                    if($data2){
                                        ...
                                        $sql3="INSERT INTO teachers (USER_ID, NAMEE, DEPARTMENT, JOINING_DATE, PHONE_NO) VALUES ('$key[0]','$teacherName','$department','$joiningDate',$phoneNo)";
                                ...
                                if(in_array($SUB3,$allowed_sub)){
                                    ...
                                    if($data4){
                                        ...
                                        if($data){
                                            $sub_row=mysqli_fetch_array($data);
                                            if($sub_row['TEACHER_ID']==null){
                                                $sql5="UPDATE subjects SET TEACHER_ID='$teacherkey[0]' WHERE SUBJECT_NAME='$SUB3'";
                                                $data5=mysqli_query($dbcon,$sql5);
                                            }else if($sub_row['TEACHER_ID2']==null){
                                                $sql5="UPDATE subjects SET TEACHER_ID2='$teacherkey[0]' WHERE SUBJECT_NAME='$SUB3'";
                                                $data5=mysqli_query($dbcon,$sql5);
                                            }
                                            //Now we have to give acess to teacher to know details about students of this batch
                                            //So lets add this batch to routemap table
                                ...
                                if(in_array($SUB4,$allowed_sub)){
                                    ...
                                    if($data4){
                                        ...
                                        if($data){
                                            $sub_row=mysqli_fetch_array($data);
                                            if($sub_row['TEACHER_ID']==null){
                                                $sql5="UPDATE subjects SET TEACHER_ID='$teacherkey[0]' WHERE SUBJECT_NAME='$SUB4'";
                                                $data5=mysqli_query($dbcon,$sql5);
                                            }else if($sub_row['TEACHER_ID2']==null){
                                                $sql5="UPDATE subjects SET TEACHER_ID2='$teacherkey[0]' WHERE SUBJECT_NAME='$SUB4'";
                                                $data5=mysqli_query($dbcon,$sql5);
                                            }
                                            //Now we have to give acess to teacher to know details about students of this batch
                                            //So lets add this batch to routemap table
